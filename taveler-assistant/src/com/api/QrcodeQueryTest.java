...
public class QrcodeQueryTest {
	...
	public static void main(String[] args) throws Exception {
		...
		request.setServiceUrl("https://ip:port/api/qrcode/V2/query");
		...
		bizContent.setOutTradeNo("ZHL777O15002039");//该字段非必输项,out_trade_no和order_id选一项上送即可
